...
#if UNITY_EDITOR
[CustomPropertyDrawer(typeof(ListOfWorlds))]
class ListOfWorldsDrawer : PropertyDrawer
{
	//private readonly int[] primes = {0, 1, 2};
	private readonly string[] listToShow;
	
    public ListOfWorldsDrawer()
    {
        listToShow = Levels.GetListOfWorlds();
    }
