...
{
    [Serializable]
    public class ListOfClothingCategories
    {
        public int Index;
    }
}
...
#if UNITY_EDITOR
[CustomPropertyDrawer(typeof(ListOfClothingCategories))]
class ListOfClothingCategoriesDrawer : PropertyDrawer
{
	//private readonly int[] primes = {0, 1, 2};
	private readonly string[] listToShow;
	
    public ListOfClothingCategoriesDrawer()
    {
        listToShow = ConvertListStringToArray(ClothingFactory.instance.itemCategories);
    }
