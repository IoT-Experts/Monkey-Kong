...
{
    [Serializable]
    public class ListOfInputControls
    {
        public int Index;
    }
}
...
#if UNITY_EDITOR
[CustomPropertyDrawer(typeof(ListOfInputControls))]
class ListOfInputControlsDrawer : PropertyDrawer
{
	//private readonly int[] primes = {0, 1, 2};
	private readonly string[] listToShow = new string[] { };
	
    public ListOfInputControlsDrawer()
    {
        listToShow = ConvertListStringToArray(InputControlsManager.instance.inputNames);
    }
