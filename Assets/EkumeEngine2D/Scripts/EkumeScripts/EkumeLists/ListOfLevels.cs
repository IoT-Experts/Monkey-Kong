...
#if UNITY_EDITOR
[CustomPropertyDrawer(typeof(ListOfLevels))]
class ListOfLevelsDrawer : PropertyDrawer
{
	//private readonly int[] primes = {0, 1, 2};
	private readonly string[] listToShow;
	
    public ListOfLevelsDrawer()
    {
        listToShow = Levels.GetListOfLevelIdentifications();
    }
