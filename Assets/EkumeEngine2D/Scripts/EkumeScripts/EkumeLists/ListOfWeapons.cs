...
#if UNITY_EDITOR
[CustomPropertyDrawer(typeof(ListOfWeapons))]
class ListOfWeaponsDrawer : PropertyDrawer
{
	//private readonly int[] primes = {0, 1, 2};
	private readonly string[] listToShow;
	
    public ListOfWeaponsDrawer()
    {
        listToShow = ConvertListStringToArray(WeaponFactory.instance.weaponNames);
    }
